...
package com.legalzoom.ui.config;

import com.legalzoom.ui.util.CsvHttpMessageConverter;
...
@ComponentScan("com.legalzoom.ui")
public class WebApplicationStarter extends SpringBootServletInitializer {
	...
	public HttpMessageConverters additionalConverters() {
		return new HttpMessageConverters(new CsvHttpMessageConverter<>());
	}
